...
#PrintScreen::
	 ...
	 * Capture screenshot.
	*/
	msgbox, Before capture
	CaptureScreen(1, False, newFileName, 100)

	msgbox, before convert
	Convert(0, "g:\%newfilename%")   ; Save the bitmap in the clipboard to sFileTo if sFileFr is "" or 0.
...
CaptureScreen(aRect = 1, bCursor = False, sFile = "", nQuality = "")
{
	If	!aRect
	{
		SysGet, nL, 76
