; Show a GUI that positions itself based on monitor characteristics
...
Gui, Show, % "w" Width " NA" " x" (A_ScreenWidth - Width/.4) " y150" ; % Screen width is for all monitors
