...
Ctrl-L|More Info display
Shift-U|Ultimate Eye Candy Panel
Shift-P|Prop & Tree Anarchy
Keypad-4|Electricity Assets Toolbar
Keypad-5|Water and Sewage Assets Toolbar
Keypad-6|Garbage Assets Toolbar
Keypad-7|Roads Assets Toolbar
Keypad-8|Zoning Assets Toolbar
Keypad-9|Districts Assets Toolbar
)
...
t8block2title = 2-Roundabout/Pedestrian Bridge
t8block2rows = 8
...
(
~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~~~~~
Ctrl-O|Open/close tool roundabout
=/-|Increase/decrease radion
Ctrl-B| Open Pedestrian Bridge Builder
)
